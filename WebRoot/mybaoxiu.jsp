...
<html>
  <head>
    ...
    <title>My JSP 'mybaoxiu.jsp' starting page</title>
  ...
  <br/>
    <h2 align="center">报修信息</h2>
   	<table width="100%" align="center" border="1">
    	...
    	<%
			...
			ResultSet rs=st.executeQuery("select * from baoxiu where nameid='"+nameid2+"'");
			while(rs.next()){
    	 %>
    	 <tr>
    ...
    <p align="center"><input type="submit" value="我要报修" onclick="window.location.href='baoxiuinsert.jsp'"/></p>
  </body>
</html>
